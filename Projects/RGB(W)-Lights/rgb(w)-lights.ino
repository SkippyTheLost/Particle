...
#define WIFI_SSID1 Bigpond827394 // Wifi network name
#define WIFI_PASS1 2E0FF0B0E0 // Wifi network password

// }

Adafruit_NeoPixel pixels(PIXEL_COUNT, PIXEL_PIN, PIXEL_TYPE); // Initialises neopixels
